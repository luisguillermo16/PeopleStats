...
<div class="table-responsive">
    <table class="table">
        ...
        @forelse ($votantes as $votante)
            ...
            {{-- Modal de Detalles --}}
            <div class="modal fade" id="detailModal{{ $votante->id }}" tabindex="-1">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">
                                <i class="bi bi-person-circle me-2"></i>
                                <span class="d-none d-sm-inline">Detalles del Votante</span>
                                        ...
                                        <div class="card-body">
                                            <div class="row g-3">
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <p class="mb-0">{{ $votante->nombre }}</p>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <strong class="text-primary">Cédula:</strong>
                                                    <p class="mb-0">{{ $votante->cedula }}</p>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <strong class="text-primary">Teléfono:</strong>
                                                    <p class="mb-0">
                                                        @if($votante->telefono)
                                                            <a href="tel:{{ $votante->telefono }}">{{ $votante->telefono }}</a>
                                                        @else
                                                            <span class="text-muted">No registrado</span>
                                                        @endif
                                                    </p>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <strong class="text-primary">Mesa Electoral:</strong>
                                                    <p class="mb-0">{{ $votante->mesa }}</p>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <strong class="text-primary">Líder Asignado:</strong>
                                                    <p class="mb-0">{{ optional($votante->lider)->name ?? 'Sin asignar' }}</p>
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <strong class="text-primary">Concejal:</strong>
                                                    <p class="mb-0">
                                                        @php
                                                            $concejal = null;
                                                            if($votante->concejal_id) {
                                                        ...
                                                        @if($concejal)
                                                            {{ $concejal->name }}
                                                        @elseif($votante->concejal_id)
                                                            <span class="text-warning">ID: {{ $votante->concejal_id }} (Usuario no encontrado)</span>
                                                        @else
                                                            <span class="text-muted">Sin asignar</span>
                                                        @endif
                                                    </p>
                        ...
                        <div class="modal-footer p-4">
                            ...
                            @if($votante->telefono)
                                <a href="tel:{{ $votante->telefono }}" class="btn btn-success">
