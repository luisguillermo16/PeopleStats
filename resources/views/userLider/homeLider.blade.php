...
<div class="main-container">
    ...
    <div class="card">
        <div class="card-header">
            <h4><i class="fas fa-user-plus me-2"></i> Formulario de Registro</h4>
            <small>Complete todos los campos obligatorios para registrar un nuevo votante</small>
        </div>
        ...
        <div class="card-body p-4">
            <form id="formVotante">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="cedula" name="cedula" placeholder="Número de cédula" required>
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="direccion" name="direccion" placeholder="Ingrese la dirección completa" rows="3"></textarea>
                    <div class="invalid-feedback"></div>
                </div>
                ...
                <div class="card info-card">
                    <div class="card-header">
                        <h6><i class="fas fa-vote-yea me-2"></i> Opciones de Votación</h6>
                    </div>
                    <div class="card-body">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="vincular_alcalde" name="vincular_alcalde" value="1">
                            <label class="form-check-label" for="vincular_alcalde">Vincular con candidato a alcalde</label>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    .card { background: white; border: none; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); }

    .card-header {
        background: linear-gradient(135deg, #1e293b 0%, #334155 100%);
        color: white; border: none; padding: 24px;
    }

    .card-header h4 { margin: 0; font-size: 1.5rem; font-weight: 600; }
    .card-header small { opacity: 0.8; font-size: 0.9rem; }

    .form-control {
        border-radius: 8px; border: 1px solid #e2e8f0; padding: 12px 16px;
        font-size: 0.95rem; transition: all 0.3s ease; background-color: #f8fafc;
    }

    .form-control:focus {
        border-color: #3b82f6; box-shadow: 0 0 0 0.2rem rgba(59, 130, 246, 0.15);
        background-color: white;
    }

    .form-label { font-weight: 600; color: #374151; margin-bottom: 8px; font-size: 0.9rem; }
    .form-label i { color: #6b7280; margin-right: 8px; }
    ...
    .btn-secondary:hover {
        ...
        transform: translateY(-1px); box-shadow: 0 4px 12px rgba(107, 114, 128, 0.4);
    }

    .info-card {
        background: linear-gradient(135deg, #0ea5e9 0%, #0284c7 100%);
        border: none; border-radius: 10px; color: white; margin-top: 20px;
    }
    ...
    .form-check-label { color: white; font-weight: 500; }
    ...
    .invalid-feedback {
        ...
        font-size: 0.875rem; margin-top: 4px; font-weight: 500;
    }

    .form-group { margin-bottom: 1.5rem; }
    .page-title { color: #1e293b; font-size: 2rem; font-weight: 700; margin-bottom: 24px; text-align: center; }
    .submit-btn { min-width: 160px; }
    .back-btn { min-width: 120px; }
    textarea.form-control { resize: vertical; min-height: 100px; }

    @media (max-width: 768px) {
        .main-container { margin: 10px auto; padding: 0 15px; }
